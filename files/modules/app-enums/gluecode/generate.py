...
def run(params):
    ...
    # cpp configuration
    cpp_namespace = "ezored::enums"
    cpp_include_prefix = "ezored/enums/"
    cpp_out = "generated-src/cpp/{0}".format(cpp_include_prefix)

    # objc configuration
    objc_prefix = "EZREnums"
    ...
    jni_class = "EZREnumsFooBar"
    jni_file = "EZREnumsFooBar"
