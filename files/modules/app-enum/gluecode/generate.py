...
def run(params):
    ...
    # cpp configuration
    cpp_namespace = "ezored::enumerator"
    cpp_include_prefix = "ezored/enumerator/"
    cpp_out = "generated-src/cpp/{0}".format(cpp_include_prefix)

    # objc configuration
    objc_prefix = "EZREnumerator"
    ...
    # java configuration
    java_package = "com.ezored.enumerator"
    ...
    jni_class = "EZREnumeratorFooBar"
    jni_file = "EZREnumeratorFooBar"
