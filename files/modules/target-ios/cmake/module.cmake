if(PROJECT_TARGET_NAME STREQUAL "ios")
    ...
    file(GLOB_RECURSE H_FILES_APP_ENUMS "${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/objc/*.h")
    file(GLOB_RECURSE S_FILES_APP_ENUMS "${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/objc/*.mm")
    ...
    file(GLOB_RECURSE H_FILES_APP_DATA_SERVICES "${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/objc/*.h")
    file(GLOB_RECURSE S_FILES_APP_DATA_SERVICES "${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/objc/*.mm")

    file(GLOB_RECURSE H_FILES_APP_SYSTEM_SERVICES "${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/objc/*.h")
    file(GLOB_RECURSE S_FILES_APP_SYSTEM_SERVICES "${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/objc/*.mm")

    file(GLOB_RECURSE H_FILES_APP_HELPERS "${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/objc/*.h")
    file(GLOB_RECURSE S_FILES_APP_HELPERS "${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/objc/*.mm")
    ...
    project_add_search_path("${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/objc")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-core/gluecode/generated-src/objc")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/objc")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/objc")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/objc")
