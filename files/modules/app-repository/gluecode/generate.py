...
def run(params):
    ...
    # cpp configuration
    cpp_namespace = "ezored::repository"
    cpp_include_prefix = "ezored/repository/"
    cpp_out = "generated-src/cpp/{0}".format(cpp_include_prefix)

    # objc configuration
    objc_prefix = "EZRRepository"
    ...
    # java configuration
    java_package = "com.ezored.repository"
    ...
    jni_class = "EZRRepositoryFooBar"
    jni_file = "EZRRepositoryFooBar"
