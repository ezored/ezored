...
def run(params):
    ...
    # java configuration
    java_package = "{0}.repository".format(
    ...
    jni_class = "{0}RepositoryFooBar".format(
        gluecode_config["jni_class_prefix"],
    )
    jni_file = "{0}RepositoryFooBar".format(
