...
def run(params):
    ...
    jni_class = "{0}DomainFooBar".format(
        gluecode_config["jni_class_prefix"],
    )
    jni_file = "{0}DomainFooBar".format(
