...
private:
    ...
    const jmethodID jconstructor{::djinni::jniGetMethodID(clazz.get(), "<init>", "(JLjava/lang/String;Ljava/lang/String;Lcom/ezored/enumerator/CustomerStatusEnumerator;)V")};
    ...
    const jfieldID field_mStatus{::djinni::jniGetFieldID(clazz.get(), "mStatus", "Lcom/ezored/enumerator/CustomerStatusEnumerator;")};
};
