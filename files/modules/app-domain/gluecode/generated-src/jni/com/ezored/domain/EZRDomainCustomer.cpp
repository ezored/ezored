...
#include "com/ezored/enumerator/EZREnumeratorCustomerStatusEnumerator.hpp"
...
auto EZRDomainCustomer::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    ...
    auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                           ...
                                                           ::djinni::get(::djinni_generated::EZREnumeratorCustomerStatusEnumerator::fromCpp(jniEnv, c.status)))};
...
auto EZRDomainCustomer::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
    ...
    return {::djinni::I64::toCpp(jniEnv, jniEnv->GetLongField(j, data.field_mId)),
            ...
            ::djinni_generated::EZREnumeratorCustomerStatusEnumerator::toCpp(jniEnv, jniEnv->GetObjectField(j, data.field_mStatus))};
}
