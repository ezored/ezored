...
def run(params):
    ...
    # cpp configuration
    cpp_namespace = "ezored::dataservices"
    cpp_include_prefix = "ezored/dataservices/"
    cpp_out = "generated-src/cpp/{0}".format(cpp_include_prefix)

    # objc configuration
    objc_prefix = "EZRDataServices"
    ...
    # java configuration
    java_package = "com.ezored.dataservices"
