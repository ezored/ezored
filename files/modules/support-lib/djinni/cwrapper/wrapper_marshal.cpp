...
static CreateExceptionFnPtr s_djinni_create_exception;
static DeleteExceptionFnPtr s_djinni_exception___delete;

// Structure holding current exception, if any
struct ExceptionState
{
    static djinni::Handle<DjinniFrontEndExceptionHandle> newHandle(DjinniFrontEndExceptionHandle *c_ptr)
    {
        return djinni::Handle<DjinniFrontEndExceptionHandle>(c_ptr, s_djinni_exception___delete);
    }

    djinni::Handle<DjinniFrontEndExceptionHandle> takeException()
    {
    ...
    djinni::Handle<DjinniFrontEndExceptionHandle> handle;
};

// Current exception state
static thread_local ExceptionState s_exception_state;

// to be called from front-end
void djinni_create_and_set_cpp_exception(DjinniFrontEndExceptionHandle *exception_handle)
{
    s_exception_state.handle = ExceptionState::newHandle(exception_handle);
}

void _djinni_add_callback_create_exception_from_cpp(CreateExceptionFnPtr fct_ptr)
{
    s_djinni_create_exception = fct_ptr;
}
...
void djinni::cw_default_throw_exception(djinni::Handle<DjinniFrontEndExceptionHandle> e_handle)
{
    throw djinni::front_end_exception(std::move(e_handle));
}

DJINNI_WEAK_DEFINITION
void djinni::cw_throw_exception(djinni::Handle<DjinniFrontEndExceptionHandle> e_handle)
{
    cw_default_throw_exception(std::move(e_handle));
}

// to be called from cpp to allow cpp impl to know about front-end exception
...
djinni::Handle<DjinniFrontEndExceptionHandle> djinni::cw_default_get_front_end_exception(const std::exception_ptr &e_ptr) noexcept
{
    try
    {
        if (e_ptr)
    ...
    { // exception generated by front-end code
        return e.takeFrontEndException();
    }
    catch (const std::exception &e)
    { // exception generated by user cpp code
...
// Creates or retrieves a handle to a front-end exception from the exception_ptr
DJINNI_WEAK_DEFINITION
djinni::Handle<DjinniFrontEndExceptionHandle> djinni::cw_get_front_end_exception(const std::exception_ptr &e_ptr) noexcept
{
    return cw_default_get_front_end_exception(e_ptr);
}

// Create a front-end exception from the exception pointer, and set it in s_exception_state to allow
// the front-end code to notice an exception was thrown. The argument is an exception_ptr for either
// a std::exception or a subclass of std::exception called front_end_exception
void djinni::cw_set_pending_exception(const std::exception_ptr &e_ptr)
{
    s_exception_state.handle = cw_get_front_end_exception(e_ptr);
}

DjinniFrontEndExceptionHandle *djinni_check_and_clear_exception()
{
...
// OPTIONAL INTEGERS
DjinniBoxedI8 *create_djinni_boxed_i8(int8_t dopt)
{
    return DjinniBoxedI8::newOptional(dopt).release();
}
...
DjinniBoxedI16 *create_djinni_boxed_i16(int16_t dopt)
{
    return DjinniBoxedI16::newOptional(dopt).release();
}
...
DjinniBoxedI32 *create_djinni_boxed_i32(int32_t dopt)
{
    return DjinniBoxedI32::newOptional(dopt).release();
}
...
DjinniBoxedI64 *create_djinni_boxed_i64(int64_t dopt)
{
    return DjinniBoxedI64::newOptional(dopt).release();
}
...
DjinniBoxedF32 *create_djinni_boxed_f32(float dopt)
{
    return DjinniBoxedF32::newOptional(dopt).release();
}
...
DjinniBoxedF64 *create_djinni_boxed_f64(double dopt)
{
    return DjinniBoxedF64::newOptional(dopt).release();
}
...
// OPTIONAL BOOL
DjinniBoxedBool *create_djinni_boxed_bool(bool dopt)
{
    return DjinniBoxedBool::newOptional(dopt).release();
}
...
DjinniBoxedDate *create_djinni_boxed_date(uint64_t dopt)
{
    return DjinniBoxedDate::newOptional(DjinniDate::toCpp(dopt)).release();
}
