...
// Exceptions: relevant for exceptions thrown both from front-end and C++.
struct DjinniFrontEndExceptionHandle;

// Exceptions: create C++ exceptions from front-end.
void djinni_create_and_set_cpp_exception(struct DjinniFrontEndExceptionHandle *exception_handle);

// Exceptions: create front-end exceptions from C++.
typedef struct DjinniFrontEndExceptionHandle *(*CreateExceptionFnPtr)(struct DjinniString *);
void _djinni_add_callback_create_exception_from_cpp(CreateExceptionFnPtr fct_ptr); // called in cpp

typedef void (*DeleteExceptionFnPtr)(struct DjinniFrontEndExceptionHandle *);
void _djinni_add_callback_exception___delete(DeleteExceptionFnPtr fct_ptr); // called in cpp

struct DjinniFrontEndExceptionHandle *djinni_check_and_clear_exception(void); // called in front-end
