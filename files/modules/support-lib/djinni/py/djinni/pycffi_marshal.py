...
class CPyBoxedI8(CPyBoxedBase):
    ...
    def toPyOptWithoutTakingOwnership(dopt):
        return CPyBoxedBase.toPyOptWithoutTakingOwnership(
            dopt, lib.get_djinni_boxed_i8_data
        )
...
class CPyBoxedI16(CPyBoxedBase):
    ...
    def toPyOptWithoutTakingOwnership(dopt):
        return CPyBoxedBase.toPyOptWithoutTakingOwnership(
            dopt, lib.get_djinni_boxed_i16_data
        )
...
class CPyBoxedI32(CPyBoxedBase):
    ...
    def toPyOptWithoutTakingOwnership(dopt):
        return CPyBoxedBase.toPyOptWithoutTakingOwnership(
            dopt, lib.get_djinni_boxed_i32_data
        )
...
class CPyBoxedF32(CPyBoxedBase):
    ...
    def toPyOptWithoutTakingOwnership(dopt):
        return CPyBoxedBase.toPyOptWithoutTakingOwnership(
            dopt, lib.get_djinni_boxed_f32_data
        )
...
class CPyBoxedF64(CPyBoxedBase):
    ...
    def toPyOptWithoutTakingOwnership(dopt):
        return CPyBoxedBase.toPyOptWithoutTakingOwnership(
            dopt, lib.get_djinni_boxed_f64_data
        )
...
class CPyStringBinaryHelper:
    ...
    def toPy(ds, cpytype):
        assert (
            ds != ffi.NULL
        )  # not sure if assert(ds) means the same thing because Python..
...
class CPyStructuredBase:
    ...
    def toPy(c_data_set, c_ptr):
        assert (
            c_ptr != ffi.NULL
        )  # not sure if assert(c_ptr) means the same thing because Python..
