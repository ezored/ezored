if(PROJECT_TARGET_NAME STREQUAL "android")
    ...
    file(GLOB_RECURSE H_FILES_APP_ENUMS "${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/jni/*.h")
    file(GLOB_RECURSE S_FILES_APP_ENUMS "${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/jni/*.cpp")
    ...
    file(GLOB_RECURSE H_FILES_APP_DATA_SERVICES "${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/jni/*.h")
    file(GLOB_RECURSE S_FILES_APP_DATA_SERVICES "${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/jni/*.cpp")

    file(GLOB_RECURSE H_FILES_APP_SYSTEM_SERVICES "${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/jni/*.h")
    file(GLOB_RECURSE S_FILES_APP_SYSTEM_SERVICES "${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/jni/*.cpp")

    file(GLOB_RECURSE H_FILES_APP_HELPERS "${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/jni/*.h")
    file(GLOB_RECURSE S_FILES_APP_HELPERS "${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/jni/*.cpp")
    ...
    project_add_search_path("${PROJECT_MODULES_PATH}/app-enums/gluecode/generated-src/jni")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-core/gluecode/generated-src/jni")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-data-services/gluecode/generated-src/jni")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-system-services/gluecode/generated-src/jni")
    project_add_search_path("${PROJECT_MODULES_PATH}/app-helpers/gluecode/generated-src/jni")
