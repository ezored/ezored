...
def run(params):
    ...
    # java configuration
    java_package = "{0}.enumerator".format(
    ...
    jni_class = "{0}EnumeratorFooBar".format(
        gluecode_config["jni_class_prefix"],
    )
    jni_file = "{0}EnumeratorFooBar".format(
