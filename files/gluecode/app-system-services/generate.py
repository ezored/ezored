...
def run(params):
    ...
    # cpp configuration
    cpp_namespace = "ezored::systemservices"
    cpp_include_prefix = "ezored/systemservices/"
    cpp_out = "generated-src/cpp/{0}".format(cpp_include_prefix)

    # objc configuration
    objc_prefix = "EZRSystemServices"
    ...
    # java configuration
    java_package = "com.ezored.systemservices"
    ...
    jni_class = "EZRSystemServicesFooBar"
    jni_file = "EZRSystemServicesFooBar"
