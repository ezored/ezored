    ...
    private void doActionHttpsRequest() {
        ...
        UIUtil.runOnNewThread(new Closure() {
            ...
            public void exec() {
                ...
                HttpRequest request = new HttpRequest("http://httpbin.org/post", HttpMethod.POST, params, headers, "");
    ...
    private void doActionHttpRequest() {
        ...
        UIUtil.runOnNewThread(new Closure() {
            ...
            public void exec() {
                ...
                HttpRequest request = new HttpRequest("https://httpbin.org/post", HttpMethod.POST, params, headers, "");
                final HttpResponse response = HttpClient.shared().doRequest(request);
